...
- A solution written in easy to understand and modern PHP
- Simple UI in React/TypeScript. It doesn’t have to be super polished, but it can’t be ugly
